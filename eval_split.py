...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', default=root_dir + '/sampled_results_align_235000/', type=str)
    ...
    parser.add_argument('--protein_root', type=str, default='/home/chom5621/IPDiff/datasets/crossdocked_v1.1_rmsd1.0')
